    ...
    return (
        <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a href="#" className="p-4 rounded-xl border border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors flex items-center gap-3">
                    <span className="text-2xl">📄</span>
                    <div>
                        <div className="font-bold">Resume</div>
                        <div className="text-sm text-gray-500">PDF (120KB)</div>
                    </div>
                </a>
