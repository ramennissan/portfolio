    ...
    <header className="mb-6 w-full">
      <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 px-6">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="mt-2 flex items-center gap-1 flex-nowrap whitespace-nowrap overflow-x-auto sm:overflow-x-visible text-sm">
            <a href="mailto:ramen.nissan@hotmail.com" className="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 hover:underline flex-shrink-0">ramen[dot]nissan[at]hotmail[dot]com</a>
            <span className="mx-1 text-gray-400 flex-shrink-0">•</span>
            <a href="mailto:ramen.nissan@torontomu.ca" className="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 hover:underline flex-shrink-0">ramen[dot]nissan[at]torontomu[dot]ca</a>
          </p>
