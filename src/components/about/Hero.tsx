    ...
    <header className="mb-6 w-full">
      <div className="max-w-3xl mx-auto flex items-center gap-6 px-6">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-2 flex items-center gap-1 flex-wrap md:flex-nowrap overflow-x-auto md:overflow-visible">
            <a href="mailto:ramen.nissan@hotmail.com" className="text-sm text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 hover:underline break-all md:break-normal md:whitespace-nowrap">ramen[dot]nissan[at]hotmail[dot]com</a>
            <span className="mx-1 text-gray-400">•</span>
            <a href="mailto:ramen.nissan@torontomu.ca" className="text-sm text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 hover:underline break-all md:break-normal md:whitespace-nowrap">ramen[dot]nissan[at]torontomu[dot]ca</a>
          </p>
